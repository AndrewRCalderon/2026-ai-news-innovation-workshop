...
2. **Ask questions.** Understand it better.
3. **Form a hypothesis.** About how to solve it.
4. **Test / prototype.** Try something concrete.
5. **Learn something.** Whatever the result tells you.
6. **Reframe the problem.** [hinge step] Go back and revise your understanding.
7. **Repeat.** This is the whole cycle, again.

**Sources**
1. https://www.nngroup.com/articles/design-thinking/ — Nielsen Norman Group explains design thinking as a non-linear, iterative process where teams cycle back to redefine the problem after testing reveals new insights.

## 2. Finding a Problem Worth Solving

A series of questions meant to help you think, not to be "answered correctly."
...
A hypothesis is: **"If I do X, then Y will happen."** For an AI project: "If I use AI to [specific task], then [specific outcome] will happen for [specific person/group]."

- "If I use AI to analyze court documents, then reporters can identify patterns 10x faster, so we can cover more cases with the same team."
...
Your goal is what you're actually trying to build and test. Three parts:

**The problem**: Clear, one sentence. "Reporters spend hours manually sifting through court documents to find relevant cases."
**The solution**: What you'll actually build. "Use AI to automatically categorize and flag court documents by relevance."
**The success metric**: How you'll know it worked. "Reporters find relevant cases 5x faster, and AI correctly flags 80%+ of relevant documents."

> "I want to solve [PROBLEM] by building [SOLUTION] so that [OUTCOME]. I'll know it works when [METRIC]."
