...
> Before you refine anything on your own, say your idea out loud and see what the room does with it.

<!-- Content-architecture note: §1's heading itself is "Why We Start Out Loud" — first-person-plural baked structurally into the section title, same pattern as 01-state-of-ai's "The Moment We're In." Decide the voice call once for Day 1 rather than per page. -->
...
- You'll hear what everyone else is building, too.
- Nothing here is final — this is just a first pass.
