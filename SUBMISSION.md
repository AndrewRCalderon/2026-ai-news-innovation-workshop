...
- **Solution:** *What you actually built, and how well it addresses the problem above. e.g. "A script that pulls agendas from three local government sites, flags items matching a keyword list, and sends a daily email — works for the sites I tested, not yet generalized to other formats."*
